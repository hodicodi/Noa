...
export class Generated1781689319038 implements MigrationInterface {
    name = 'Generated1781689319038'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "noa"."user" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_administor" boolean NOT NULL, CONSTRAINT "PK_a95e949168be7b7ece1a2382fed" PRIMARY KEY ("uuid"))`);
        ...
        await queryRunner.query(`CREATE TABLE "noa"."song" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "publish_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::date, "views" integer NOT NULL, "length" integer NOT NULL, "genere" "noa"."song_genere_enum" NOT NULL DEFAULT 'rock', "personal_playlist_uuid" uuid, "album_uuid" uuid, CONSTRAINT "PK_a0f6ee70290deaf2039ba28ed6a" PRIMARY KEY ("uuid"))`);
        await queryRunner.query(`CREATE TYPE "noa"."artist_artist_type_enum" AS ENUM('singer', 'band', 'pair')`);
        await queryRunner.query(`CREATE TABLE "noa"."artist" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "artist_type" "noa"."artist_artist_type_enum" NOT NULL DEFAULT 'singer', CONSTRAINT "PK_74d7294bff9579a42089ccfd82e" PRIMARY KEY ("uuid"))`);
