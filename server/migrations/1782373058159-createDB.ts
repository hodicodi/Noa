...
export class CreateDB1782373058159 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "noa"."song" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "create_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_date" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "publish_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::date, "genre" "noa"."song_genre_enum" NOT NULL DEFAULT 'rock', "album_uuid" uuid NOT NULL, CONSTRAINT "PK_a0f6ee70290deaf2039ba28ed6a" PRIMARY KEY ("uuid"))`);
