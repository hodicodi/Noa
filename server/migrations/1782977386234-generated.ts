...
export class Generated1782977386234 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "noa"."personal_playlist" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "create_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_date" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "type" "noa"."personal_playlist_type_enum" NOT NULL DEFAULT 'History', "user_uuid" uuid, CONSTRAINT "UQ_80ab51259c3cc3a0bf573e58c3b" UNIQUE ("name"), CONSTRAINT "PK_8e6581d9ad2fff84e7fc087efa8" PRIMARY KEY ("uuid"))`);
        await queryRunner.query(`CREATE TYPE "noa"."song_genre_enum" AS ENUM('Rock', 'Pop', 'Hip-hop', 'Country')`);
        await queryRunner.query(`CREATE TABLE "noa"."song" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "create_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_date" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "publish_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::date, "genre" "noa"."song_genre_enum" NOT NULL DEFAULT 'Rock', "s3_url" character varying NOT NULL, "album_uuid" uuid NOT NULL, CONSTRAINT "PK_a0f6ee70290deaf2039ba28ed6a" PRIMARY KEY ("uuid"))`);
        await queryRunner.query(`CREATE TABLE "noa"."album" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "create_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_date" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "artist_uuid" uuid, CONSTRAINT "UQ_a73b466bc11b9f56ea029f22c5b" UNIQUE ("name", "artist_uuid"), CONSTRAINT "PK_ac982622311ded526b50a1c2424" PRIMARY KEY ("uuid"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "noa"."song_genre_enum"`);
